...
(function($PS) {
  ...
  var getRoute = function __do() {
      var v = Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.location))(Web_HTML_Location.hash)();
      if (v === "#roast") {
          return new Data_Maybe.Just(Roast.value);
      };
      if (v === "#chips") {
          return new Data_Maybe.Just(Chips.value);
      };
      if (v === "#salad") {
          return new Data_Maybe.Just(Salad.value);
      };
      return Data_Maybe.Nothing.value;
  };
  var router = function (cb) {
      var matchRoute = function __do() {
          ...
          throw new Error("Failed pattern match at Router (line 25, column 15 - line 27, column 37): " + [ v.constructor.name ]);
      };
      return function __do() {
          var v = Data_Functor.mapFlipped(Effect.functorEffect)(Web_HTML.window)(Web_HTML_Window.toEventTarget)();
          var v1 = Web_Event_EventTarget.eventListener(Data_Function["const"](matchRoute))();
          return Web_Event_EventTarget.addEventListener(Web_HTML_Event_HashChangeEvent_EventTypes.hashchange)(v1)(false)(v)();
      };
  };
  exports["Roast"] = Roast;
  exports["Chips"] = Chips;
...
(function($PS) {
  ...
  var _child3 = Data_Symbol.SProxy.value;
  var _child2 = Data_Symbol.SProxy.value;
  var _child1 = Data_Symbol.SProxy.value;
      ...
      return Halogen_HTML_Elements.div_([ (function () {
          if (state.currentRoute instanceof Router.Roast) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "child1";
              }))(Data_Ord.ordUnit)(_child1)(Data_Unit.unit)(Children.roast)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Chips) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "child2";
              }))(Data_Ord.ordUnit)(_child2)(Data_Unit.unit)(Children.chips)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (state.currentRoute instanceof Router.Salad) {
              return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "child3";
              }))(Data_Ord.ordUnit)(_child3)(Data_Unit.unit)(Children.salad)(Data_Unit.unit)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Parent (line 65, column 30 - line 68, column 90): " + [ state.currentRoute.constructor.name ]);
      })() ]);
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Router.Roast.value))(Router.getRoute)))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Parent.page)(v1)(v))(function (v2) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Router.router(function (route) {
